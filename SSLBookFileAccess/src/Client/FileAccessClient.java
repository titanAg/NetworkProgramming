            ...
            public void actionPerformed( ActionEvent event )
            {
              try {
	           toServer.writeObject("nextrecord");
                ...
                catch (IOException ioe) {} catch (ClassNotFoundException ex) {
                    Logger.getLogger(FileAccessClient.class.getName()).log(Level.SEVERE, null, ex);
                }
;
            }
